...
<header class="header fixed-top">
   ...
   <div class="container">
      ...
      <div class="row align-items-center">
         ...
         <a href="#" class="logo mr-auto"><img src="" alt="" title="" >Mafia Life Style </a>
...
<section class="reviews" id="reviews">
   ...
   <h1 class="heading">Commentaires d'utilisateurs</h1>
   ...
   <div class="container">
      ...
      <div class="contact-info-container">
         ...
         <div class="box">
            ...
            <h3>Email</h3>
            <p>neobody007@gmail.com</p>
         </div>
   
         <div class="box">
            <i class="fas fa-map"></i>
            <h3>Adresse</h3>
            <p>Bertrix, Belgique 6880</p>
         </div>
